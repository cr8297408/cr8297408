        ...
        <div className="glassmorphism-dark p-6 rounded-2xl border border-white/5">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-white font-medium">Cesar Ruiz</p>
            ...
            <div className="flex items-center space-x-3">
              <a
                ...
                className="w-8 h-8 rounded-lg bg-gradient-to-r from-blue-500/10 to-purple-600/10 flex items-center justify-center border border-white/5 hover:from-blue-500/20 hover:to-purple-600/20 transition-all duration-300"
              >
              ...
              <a
                href="https://linkedin.com/in/cesar-ruiz"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-lg bg-gradient-to-r from-blue-500/10 to-purple-600/10 flex items-center justify-center border border-white/5 hover:from-blue-500/20 hover:to-purple-600/20 transition-all duration-300"
              >
          ...
          <div className="mt-6 pt-6 border-t border-white/5 text-center">
            <p className="text-gray-500 text-xs">
              © {currentYear} Cesar Ruiz. Construido con Astro, React y Tailwind CSS
            </p>
          </div>
        </div>
      </div>
